...
$mqtt = new phpMQTT(“m10.cloudmqtt.com”, 37343, “phpMQTT Pub Example”); //เปลี่ยน www.yourmqttserver.com ไปที่ mqtt server ที่เราสมัครไว้นะครับ
...
if ($mqtt->connect()) {
$mqtt->publish(“/label”,”TV”); // ตัวอย่างคำสั่งเปิดทีวีที่จะส่งไปยัง mqtt server
$mqtt->close();
}
